...
if __name__ == "__main__":
    ...
    if args.variant == 'vanilla':
        ...
        GPTmodel = model.GPT(mconf).to(device) # [part g] Make some other model here
    else:
    ...
    if args.function == 'pretrain':
        ...
        # num_workers=4
        # writer=writer 
        hyperparameters= {"max_epochs": 650,
        "batch_size": 128,
        "learning_rate": 6e-3,
        "lr_decay": True,
        "warmup_tokens": 512*20,
        ...
        trainer.Trainer(GPTmodel, pretrain_dataset, None, tconf).train()
        ...
        if args.reading_params_path is None: #finetune without pretraining [part c-d]
            hyperparameters = {
            "max_epochs": 75,
            "batch_size": 256,
            "learning_rate": 6e-4,
        ...
        else: #[fine-tune with pretraining]
        ...
        if args.eval_corpus_path is not None:
            ...
            eval_corpus = open(args.eval_corpus_path,encoding="utf-8").read()
        ...
        tconf = trainer.TrainerConfig(**hyperparameters)
        trainer.Trainer(GPTmodel, finetune_dataset, eval_dataset, tconf).train()
